...
export default function Deposit() {
    ...
    async function handleLogin(e) {
        e.preventDefault();
        try {
            const response = await fetch("https://server-8e96.onrender.com/login", {  
                method: "POST",
    ...
    async function handleDeposit(e) {
        ...
        try {
            const response = await fetch("https://server-8e96.onrender.com/deposit", {  
                method: "POST",
                headers: { "Content-Type": "application/json" },
    ...
    return (
        <div className="deposit-container">
            <h1>Deposit Money 💰</h1>
            <p>Securely deposit funds into your Akash Bank account.</p>
