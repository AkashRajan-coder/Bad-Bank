...
export default function Alldata() {
  ...
  useEffect(() => {
    async function axiosProd() {
      try {
        const response = await axios.get("https://server-8e96.onrender.com/data");
  ...
  async function handleDelete(id) {
    try {
      await axios.delete(`https://bank-server-8e96.onrender.com/delete/${id}`);
  ...
  async function handleUpdate() {
    try {
      ...
      const response = await axios.put(`https://bank-server-8e96.onrender.com/update/${editId}`, formData);
      
      console.log("Update Response:", response.data);
  
      const updatedResponse = await axios.get("https://bank-server-8e96.onrender.com/data"); 
